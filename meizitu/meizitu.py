...
class MZiTu:
    ...
    def mkdir(self, dir_name, img_url_list):
        ...
        if os.path.isdir("/Users/junjie/PycharmProjects/test001/meizitu\图片/" + finall_dir) != True:  # 如果保存的路径不存在
            os.makedirs(r"/Users/junjie/PycharmProjects/test001/meizitu" + finall_dir)  # 如果不存在。我们将创立这个路径
        path = "/Users/junjie/PycharmProjects/test001/meizitu" + finall_dir + "/"
        return path
